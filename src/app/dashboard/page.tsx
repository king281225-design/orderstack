...
export default async function DashboardOrdersPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white dark:bg-[#241d17] px-4 py-3">
        <div>
        ...
        {history.length === 0 ? (
          ...
          <div className="flex flex-col gap-2">
            {history.slice(0, 20).map((order) => (
              <div
                key={order.id}
                className="flex items-center justify-between rounded-md border border-gray-200 bg-white dark:bg-[#241d17] px-4 py-2 text-sm"
              >
