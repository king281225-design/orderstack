...
- **Month 2:** ~~Coupons~~ **done** — see below. QR table ordering for dine-in, custom domains, subscription billing automation, and kitchen display system are still open — the last two need a live deployment/domain to mean anything.
